...
import { formatPriceE6 } from '@/lib/format';
    ...
    <div className="rounded-lg border border-border bg-card p-4">
      ...
      <div className="mb-2">
        ...
        <input
          ...
          className="w-full rounded border border-border bg-background px-3 py-2 text-sm text-foreground placeholder-muted-foreground outline-none focus:border-accent"
        />
        {sizeNative && market && (
